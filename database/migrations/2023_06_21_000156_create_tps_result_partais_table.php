...
return new class extends Migration
{
    ...
    {
        Schema::create('tps_result_partais', function (Blueprint $table) {
            ...
            // $table->foreign('data_dapil_id', 'dapil_fk_8976432')->references('data_dapil_id')->on('pasangan_calons');
            $table->foreign('kategori_pemilu_id', 'dapil_fk_89244743')->references('id')->on('kategori_pemilus');
        });
    }
    ...
    {
        Schema::dropIfExists('tps_result_partais');
    }
};
