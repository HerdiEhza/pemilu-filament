    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            {{-- @if (Auth::user()->is_admin == true) --}}
                ...
                <x-responsive-nav-link :href="route('input-suara')" :active="request()->routeIs('input-suara')">
                    {{ __('Input suara') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('list-suara.index')" :active="request()->routeIs('list-suara.index')">
                    {{ __('List suara') }}
                </x-responsive-nav-link>
            {{-- @endif --}}
        </div>
