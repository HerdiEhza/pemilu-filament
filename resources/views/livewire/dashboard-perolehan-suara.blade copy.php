    ...
    <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
            ...
            <div class="flex flex-col p-6 text-gray-900">
                ...
                <select wire:model="kategoriPemiluActive" name="kategoriPemiluActive" id="kategoriPemiluActive"
                        ...
                        <div class="rounded-lg bg-card flex justify-between p-3 h-32">
                            <div class="">
                                <div class="flex items-center">
                                    <img src="https://assets.codepen.io/3685267/mock_faces_0.jpg" alt=""
                                        class="w-10 h-10 rounded-full">
                                    <div class="ml-2">
                                        <div class="flex items-center">
                                            <div class="mr-2 font-bold text-white">{{ $paslonn->nama_pasangan_calon }}
                                            </div>
                                            <img src="https://assets.codepen.io/3685267/res-react-dash-tick.svg" alt=""
                                                class="w-4 h-4">
                                        </div>
                                        <div class="text-sm text-white">
                                            {{ $paslonn->kategoriPemilu->nama_kategori_pemilu }}</div>
                                    </div>
                                </div>
                            ...
                            <svg class="w-44 mt-3" height="6" viewBox="0 0 200 6" fill="none"
            ...
            <div class="grid w-full place-items-center text-center items-center px-6 py-24 sm:py-32 lg:px-8">
                <div
                    class="flex items-center justify-center w-16 h-16 text-yellow-500 rounded-full bg-yellow-50 dark:bg-gray-700">
