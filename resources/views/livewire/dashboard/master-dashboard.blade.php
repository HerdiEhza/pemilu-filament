<div class="py-12">
    <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
            ...
            @if ($this->kategoriPemiluActive == 1)
                @livewire('dashboard.pilpres-dashboard', [
                    ...
                    ], key('pilpres-'.$this->kategoriPemiluActive))
            @endif
            @if ($this->kategoriPemiluActive == 2)
                @livewire('dashboard.dpr-dashboard', [
                    'kategoriPemiluActive' => $this->kategoriPemiluActive,
                    'provinsiActive' => $this->provinsiActive,
                    'dataDapilActive' => $this->dataDapilActive,
                    'kabKotaActive' => $this->kabKotaActive,
                    'kecamatanActive' => $this->kecamatanActive,
                    ], key('dpr-'.$this->kategoriPemiluActive))
            @endif
            @if ($this->kategoriPemiluActive == 3)
                @livewire('dashboard.dprd-prov-dashboard', [
                    'kategoriPemiluActive' => $this->kategoriPemiluActive,
                    'provinsiActive' => $this->provinsiActive,
                    'dataDapilActive' => $this->dataDapilActive,
                    'kabKotaActive' => $this->kabKotaActive,
            ...
            @if ($this->kategoriPemiluActive == 4)
                @livewire('dashboard.dprd-kab.provinsi-dashboard', [
                    ...
                    'kabKotaActive' => $this->kabKotaActive,
                    'kecamatanActive' => $this->kecamatanActive,
                    ], key('dprd-kab-'.$this->kategoriPemiluActive))
            @endif
            @if ($this->kategoriPemiluActive == 5)
                @livewire('dashboard.dpd-dashboard', [
                    'kategoriPemiluActive' => $this->kategoriPemiluActive,
                    'provinsiActive' => $this->provinsiActive,
                    'dataDapilActive' => $this->dataDapilActive,
                    'kabKotaActive' => $this->kabKotaActive,
                    'kecamatanActive' => $this->kecamatanActive,
                    ], key('dpd-'.$this->kategoriPemiluActive))
            @endif
        </div>
    </div>
</div>
